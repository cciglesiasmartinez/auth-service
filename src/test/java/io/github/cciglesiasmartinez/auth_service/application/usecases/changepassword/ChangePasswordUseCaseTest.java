...
public class ChangePasswordUseCaseTest {
    ...
    void shouldChangePassword() {
        ...
        PlainPassword newPassword = PlainPassword.of("N3wPassw0rd!");
        ...
        // Then
        verify(user).changePassword(currentPassword, newPassword, passwordEncoder);
    ...
    void shouldThrowException_whenUserIsExternallyAuthenticated() {
        ...
        Username username = Username.of("externalUser");
